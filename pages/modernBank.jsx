  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={bankImg} alt='/' />
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Bank Landing Page</h2>
                <h3 className=''>React JS / Tailwind </h3>
            </div>
        </div>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <h2>Overview</h2>
                <p>
                   A modern bank landing page that's responsive and looks great on all devices. The page has a navgiation menu, hero section,
