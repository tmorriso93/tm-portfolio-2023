  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={aiShirtImgGen} alt='/' />
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>AI 3D T-Shirt Logo Generator</h2>
                <h3 className=''>React JS / ThreeJS / TailWindCSS</h3>
            </div>
        </div>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <button className='px-8 py-2 mt-4 mr-8'><a href="https://github.com/tmorriso93/3D-Ai-Shirt-Generator-App" target="_blank" rel="noreferrer" >Code</a></button>
            </div>
            <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded'>
                <div className='p-2'>
                    ...
                    <div className='grid grid-cols-3 md:grid-cols-1'>
                        ...
                        <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1' /> THREEJS</p>
