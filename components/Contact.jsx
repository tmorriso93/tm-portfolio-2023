  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
            <p className='text-xl tracking-widest uppercase text-[#db4b4b]'>Contact</p>
            ...
            <div className='grid lg:grid-cols-5 gap-8'>
                ...
                <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
                    <div className='p-4'>
                        ...
                        <form action="https://getform.io/f/74028c3e-257d-407e-a47b-bd16b09f7060" method="POST">
            ...
            <div className='flex justify-center py-12'>
                <Link href='/'>
                    <div className='rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <HiOutlineChevronDoubleUp className='text-[#db4b4b]' size={30}/>
                    </div>
                </Link>
            </div>
        </div>
